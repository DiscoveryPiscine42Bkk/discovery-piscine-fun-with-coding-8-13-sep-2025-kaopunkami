(function () {
  ...
  function renderEmptyState() {
    if (listEl.children.length === 0) {
      ...
      empty.textContent = 'ยังไม่มีงานในรายการ — กดปุ่ม "New" เพื่อเพิ่มงานใหม่';
  ...
  function makeTodoDiv(text) {
    ...
    div.title = 'คลิกเพื่อยืนยันการลบ';
  ...
  function getTodosFromDOM() {
    ...
    return Array.from(listEl.querySelectorAll('.todo')).map(el => el.textContent);
  }
